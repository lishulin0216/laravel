    ...
    <div class="uc-searchbox">
        ...
        <div class="user-option">
            <a href="/user/center" class="btn-user-option">
                <div class="user-thumb"><img src="http://thirdqq.qlogo.cn/g?b=sdk&k=A5kq77qlBmUt33icicKrEo6A&s=140&t=1496023247" width="100%" height="100%" alt="头像"></div>
    ...
    <div class="uc-top">
        <div class="uc-top-lft">
            <div class="uc-top-lft-box">
                    ...
                    <img src="http://thirdqq.qlogo.cn/g?b=sdk&k=A5kq77qlBmUt33icicKrEo6A&s=140&t=1496023247" width="100%" height="100%" alt="头像">
                </div>
                            </div>
        </div>
        <div class="mycard-name-box">
                ...
                <div class="progress-bar">
                    ...
                    还差&nbsp;<span class="progress-txt-clr">2</span>&nbsp;点经验值，<span class="progress-txt-clr2">0</span>&nbsp;个采纳就能升级了
                </div>
        ...
        <div class="uc-content">
                    <div class="uc-lft">
                        <ul class="uc-nav user_nav">
                                ...
                                <li data-type=recommend data-tp="0" data-tid="0">
                                        <a href="javascript:;" class="uc-tab"><i></i>向我推荐</a>
                                </li>
                                ...
                                <li data-type="order"><a href="javascript:;" class="uc-tab"><i></i>兑奖记录</a></li>
                        </ul>
                    </div>
	       ...
	       <div class="uc-top-bar">
			    <div class="sort-nav">
			        ...
			        <a href="javascript:;" class="sort-nav-tab user_nav_child " data-type="recommend" data-tp="1">向我求助</a>
			    </div>
			</div>
		...
		<div id="reco_list">
		    <div class="my-interest">
		        <span class="my-interest-tit">兴趣分类:</span>
		                            设置擅长分类，更快捷的回答问题<a href="javascript:;" class="btn-interest-option user_nav_child cur setUpCategory" data-type="recommend" data-tp="0" style="color: #3c82fa">设置分类</a>
		                    </div>
...
<div id="userList_mall_order" class="uc-rgt user_order_list  hide"></div>
...
<!-- <script crossorigin="anonymous" src="./js/3f83f0e.js"></script> -->
    ...
    <div class="ft-container">
        ...
        <div id="popup_wrap" style="z-index:2;"></div>
        <script crossorigin="anonymous" src="./js/idata.js"></script>
        <script crossorigin="anonymous" src="./js/dt.main.js"></script></div>
</body>
