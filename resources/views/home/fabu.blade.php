            ...
            <div class="aside-section">
                <div class="aside-ask">
                    ...
                    <ol class="aside-ask-lst">
                        ...
                        <li><span>③</span> 打上正确的标签将有助于更快地获得满意回答。</li>
                    </ol>
                </div>
            </div>
            <!-- //精彩回答 -->
        ...
        <div class="main">
            ...
            <div class="ask-wrap">
                ...
                <div class="desc_ask">
                    ...
                    <div class="ipt-box">
                        <input type="textarea" id="ask_content" cols="30" rows="3" class="popup-txtarea popup-txtarea-h4 textarea" data-maxlength="200">
                ...
                <div class="ft-bar">
                    <div class="ft-btn-box">
                        <button id="submit_question" class="btn-reply-submit">提&nbsp;&nbsp;&nbsp;&nbsp;交</button>
                    </div>
                </div>
                <!-- //ft-bar -->
            </div>
...
<script crossorigin="anonymous" src="./home/js/dt.main.js"></script> -->
